...
import { useTenantUpdate } from "./useTenantUpdate";
import EditTenantForm from "./EditTenantForm";
import CreateTenantLayout from "../../tenants/create/CreateTenantLayout";

export const EditTenantPage: React.FC = () => {
  const { id } = useParams<{ id: string }>();
  const navigate = useNavigate();
  const { tenant, loading, error, updateTenant } = useTenantUpdate(id);
